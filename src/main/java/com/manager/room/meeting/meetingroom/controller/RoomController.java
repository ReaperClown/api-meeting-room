...
import com.manager.room.meeting.meetingroom.exception.ResourceNotFoundException;
import com.manager.room.meeting.meetingroom.model.Room;
import com.manager.room.meeting.meetingroom.repository.RoomRepository;
...
public class RoomController {
    ...
    public ResponseEntity<Room> getRoomById(@PathVariable(value = "id") Long roomId) throws ResourceNotFoundException {
        Room room = roomRepository.findById(roomId)
                .orElseThrow(() -> new ResourceNotFoundException("Room with the id of " + roomId + " not found"));
